...
( function( $ ) {
	...
	wp.customize( 'listy_accent_color', function( value ) {
		value.bind( function( newval ) {
	...
	// Dark sidebar text
	wp.customize( 'listy_dark_sidebar_text', function( value ) {
		value.bind( function( newval ) {
			if ( newval == true ) {
				$( 'body' ).addClass( 'dark' );
			} else {
	...
	// Hide social
	wp.customize( 'listy_hide_social', function( value ) {
		value.bind( function( newval ) {
			if ( newval == true ) {
	...
	wp.customize( 'listy_preview_date_lowercase', function( value ) {
		value.bind( function( newval ) {
			if ( newval == true ) {
