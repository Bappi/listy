...
if ( get_theme_mod( 'listy_hide_related_posts', false ) ) return;
...
if ( $related_posts ) : ?>
	...
	<div class="section-inner wide">
		...
		<div class="related-posts">
			...
			<h3 class="related-posts-title"><?php _e( 'Related Posts', 'listy' ); ?></h3>
			...
			foreach ( $related_posts as $post ) {
				...
				if ( has_post_thumbnail() ) {
					$image = wp_get_attachment_image_src( get_post_thumbnail_id(), 'listy_preview-image' );
